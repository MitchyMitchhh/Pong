...
class Ball:
    ...
    def draw(self):
        arcade.draw_commands.draw_circle_filled(self.center.x, self.center.y, BALL_RADIUS, arcade.color.ALLOY_ORANGE)
    def advance(self):
...
class Paddle:
    def __init__(self):
        ...
        self.center.y = 25
    def draw(self):
        arcade.draw_commands.draw_rectangle_filled(self.center.x, self.center.y, PADDLE_WIDTH, PADDLE_HEIGHT, arcade.color.BLUSH)
    def move_up(self):
